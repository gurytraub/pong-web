## pong-web 
### is a web (pixi.js and material.js based) game to show case match making and multiplayer gaming using node and typescript
### The physics engine runs both on the client and the server. The GameServers (node/ typescript as well) this connects with are the pong project that can be found a www.github.com/ariellaub/pong.
